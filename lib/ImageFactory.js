                ...
                <View style={this.props.options.config.containerStyle || {}}>
                    ...
                    <View
                        ...
                        <View
                            ...
                            {(this.props.options.config.defaultUri == null || this.props.options.config.defaultUri == undefined) ?
                                <SimpleLineIcons
                                    name={'camera'}
                                    size={28}
                                    style={styles.icon}
                                ...
                                <Image
                                    ...
                                    source={{uri: this.props.options.config.defaultUri}}
                                    //source={this.state.loading ? require('./loading.gif') : {uri: this.props.options.config.defaultUri}}
